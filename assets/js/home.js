...
new Vue({
    el: '#app',
    components: { Modal: _Modal2.default, Loader: _Loader2.default },
    data: {
        formData: {
            'name': '',
            'email': '',
    ...
    methods: {
        onFormSubmit: function onFormSubmit(e) {
            var form = e.srcElement,
                validated = this.validateForm(this.formData, this.rules);

            if (validated) {
                this.sendVerificationCode();
            }
        },
        validateForm: function validateForm(data, rules) {
        ...
        highlightErrors: function highlightErrors(errors) {
        ...
        sendVerificationCode: function sendVerificationCode() {
            var url = '/verify/send',
                number = { phone: this.formData.phone };

            this.$http.post(url, number).then(function (request) {
        ...
        checkVerificationCode: function checkVerificationCode() {
            ...
            this.$http.post(url, formData).then(function (request) {
                toastr['success'](request.data, "Success");
                vm.showLoader = true;
                setTimeout(vm.createUserAndRedirect, 3000);
            }, function (error) {
                toastr['error'](error.data, "Error");
            });
        },
        createUserAndRedirect: function createUserAndRedirect() {
            var url = '/register/ajax';

            this.$http.post(url, this.formData).then(function (request) {
                //toastr['success'](request.data, "Success");
...
exports.default = {
    ...
    events: {
        'start-loader': function startLoader() {
            console.log('Started');
            this.startIt();
            this.showDots();
        }
    ...
    methods: {
        startIt: function startIt() {
            setTimeout(this.endAnim, this.timeout);
        },
        restartAnim: function restartAnim() {
            $('.loader-icon').removeClass('shrinking-cog').addClass('spinning-cog');
            $('.loader-background').addClass('color-flip');
            timer();
            $('.switches').show();
        },
        endAnim: function endAnim() {
        ...
        showDots: function showDots() {
            var dots = window.setInterval(function () {
                ...
                if (wait.innerHTML.length > 3) wait.innerHTML = "";else wait.innerHTML += ".";
            }, 100);
        }
    }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div id=\"loader\" class=\"overlay-loader\" v-show=\"show\">\n    <div class=\"loader-background color-flip\"></div>\n    <p class=\"waiting-block\">Loading<span id=\"wait\">.</span></p>\n    <img class=\"loader-icon spinning-cog\" src=\"http://pasqualevitiello.github.io/Tumblr-Style-Cog-Spinners/cogs/cog03.svg\" data-cog=\"cog03\">\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\laragon\\www\\motorman\\resources\\assets\\js\\components\\Loader.vue"
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div class=\"modal-mask\" v-show=\"show\" transition=\"modal\">\n    <div class=\"modal-wrapper\">\n        <div class=\"modal-container\">\n            <slot name=\"container\">\n            </slot>\n            <a href=\"#\" class=\"close-button\" @click.prevent=\"show = false\">\n                <i class=\"fa fa-close\">\n                </i>\n            </a>\n\n            <div class=\"modal-header\">\n                <slot name=\"header\">\n                    default header\n                </slot>\n            </div>\n\n            <div class=\"modal-body\">\n                <slot name=\"body\">\n                    default body\n                </slot>\n            </div>\n\n            <div class=\"modal-footer\">\n                <slot name=\"footer\">\n                    <button class=\"btn btn-default\" @click=\"show = false\">\n                        Cancel\n                    </button>\n                </slot>\n            </div>\n        </div>\n    </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\laragon\\www\\motorman\\resources\\assets\\js\\components\\Modal.vue"
  module.hot.dispose(function () {
    require("vueify-insert-css").cache["\n.modal-mask {\n    position: fixed;\n    z-index: 9998;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, .5);\n    display: table;\n    -webkit-transition: opacity .3s ease;\n    transition: opacity .3s ease;\n}\n\n.modal-wrapper {\n    display: table-cell;\n    vertical-align: middle;\n}\n\n.close-button{\n    position: absolute;\n    top:10px;\n    right:10px;\n    color:#000000;\n    font-size:20px;\n    z-index: 1500;\n}\n\n.modal-container {\n    position:relative;\n    width: 600px;\n    margin: 0px auto;\n    padding: 20px 30px;\n    background-color: #fff;\n    border-radius: 2px;\n    box-shadow: 0 2px 8px rgba(0, 0, 0, .33);\n    border-bottom:10px solid #F3E200;\n    border-top:10px solid #F3E200;\n    -webkit-transition: all .3s ease;\n    transition: all .3s ease;\n    font-family: Helvetica, Arial, sans-serif;\n}\n\n.modal-container input[type=text]{\n    background-color:#F0F0F0;\n}\n.modal-container p{\n    font-weight: bold;\n}\n\n.modal-header h3 {\n    margin-top: 0;\n    color: #011E9E;\n}\n\n.modal-body {\n    margin: 20px 0;\n}\n\n.modal-default-button {\n    float: right;\n}\n\n/*\n * the following styles are auto-applied to elements with\n * v-transition=\"modal\" when their visiblity is toggled\n * by Vue.js.\n *\n * You can easily play with the modal transition by editing\n * these styles.\n */\n\n.modal-enter, .modal-leave {\n    opacity: 0;\n}\n\n.modal-enter .modal-container,\n.modal-leave .modal-container {\n    -webkit-transform: scale(1.1);\n    transform: scale(1.1);\n}\n"] = false
    document.head.removeChild(__vueify_style__)
  })
